...
| ------- | ----------------------------------------- | -------------------------------- |
| Cluster | `ghcr.io/lobstertrap/openshell/cluster:latest` | `openshell gateway start`        |
| Gateway | `ghcr.io/lobstertrap/openshell/gateway:latest` | Cluster startup (via Helm chart) |
